...
pub fn compile_fn(
    ...
    let comp_fn = match fn_ {
        ...
        Function::Pad(n) => CompiledFunction::Pad(n),
        Function::PadLeft(n) => CompiledFunction::PadLeft(n),
        Function::PadTo(n) => CompiledFunction::PadTo(n),
        Function::PadToLeft(n) => CompiledFunction::PadToLeft(n),
